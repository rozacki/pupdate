...
//specialised logger for debug session
//If we pass all calls through this interface and implementation then it will be easier to change in future insetad of just using fmt...
